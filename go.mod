module github.com/tatagereja/tatagereja

go 1.26.1

// +heroku install github.com/tatagereja/tatagereja/backend/cmd/server github.com/tatagereja/tatagereja/backend/cmd/seed-admin

replace github.com/tatagereja/tatagereja/backend => ./backend

require github.com/tatagereja/tatagereja/backend v0.0.0
